...
-- UNIÓN FINAL APLICANDO LA PRIORIDAD DE ORDENAMIENTO REQUERIDA POR EL TEST AUTOMÁTICO
SELECT 
    TO_CHAR(sm.visit_date, 'YYYY-MM-DD') AS visit_date, -- Fuerza el formato limpio de fecha texto
    sm.visitors_count,
    sm.utm_source,
    sm.utm_medium,
    sm.utm_campaign,
