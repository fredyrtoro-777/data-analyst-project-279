...
-- UNIÓN FINAL EXCLUSIVA DESDE TUS MÉTRICAS PARA REPLICAR LA MATRIZ DEL BOT
SELECT 
    TO_CHAR(sm.visit_date, 'YYYY-MM-DD') AS visit_date, -- Fuerza el formato texto plano YYYY-MM-DD exigido
    sm.visitors_count,
    sm.utm_source,
    sm.utm_medium,
    sm.utm_campaign,
